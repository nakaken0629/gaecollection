...
public class SignedRequestsHelper {
    ...
    /* endpointの変更 */
    private String endpoint = "ecs.amazonaws.jp"; // must be lowercase 2
    /* Access Key IDの変更 */
    private String awsAccessKeyId = "アクセスキーIDを指定";
    /* Secret Access Keyの変更 */
    private String awsSecretKey = "シークレットアクセスキーを指定";
    private SecretKeySpec secretKeySpec = null;
    private Mac mac = null;

    /* サンプルはJava 6ではエラーとなるので、throws句を追加 */
